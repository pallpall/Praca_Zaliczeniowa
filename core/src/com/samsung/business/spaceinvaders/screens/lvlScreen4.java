...
//przedlevelowyscreen//
public class lvlScreen4 extends AbstractScreen{
    private final SpaceInvaders spaceInvaders;
    private OrthographicCamera camera;
    private BitmapFont font;
    private TouchInput touchInput;

    public lvlScreen4(SpaceInvaders spaceInvaders) {
        font = new BitmapFont();
    ...
    public void render(float delta) {
        ...
        font.draw(spaceInvaders.batch, "final level " + spaceInvaders.getScore().getValue(), 300, Gdx.graphics.getHeight()/2);
