...
//przedlevelowyscreen//
public class lvlScreen2 extends AbstractScreen{
    private final SpaceInvaders spaceInvaders;
    private OrthographicCamera camera;
    private BitmapFont font;
    private TouchInput touchInput;

    public lvlScreen2(SpaceInvaders spaceInvaders) {
        font = new BitmapFont();
    ...
    public void render(float delta) {
        ...
        font.draw(spaceInvaders.batch, "level 3 " + spaceInvaders.getScore().getValue(), 300, Gdx.graphics.getHeight()/2);
