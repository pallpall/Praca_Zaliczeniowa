...
//screengry//
public class GameScreen4 extends AbstractScreen {
    ...
    public GameScreen4(SpaceInvaders spaceInvaders) {
    ...
    public void create() {
        ...
        invasion.listenOnDestroyed(new Invasion.OnEnemyDestroyed() {
            ...
            public void onEnemyDestroyed(EnemySpaceship enemy) {
                spaceInvaders.getScore().addScore(130);
            }
        });
        ...
        invasion.listenOnInvasionDestroyed(new Invasion.OnInvasionDestroyed() {
            ...
            public void onInvasionDestroyed() {
                spaceInvaders.win4();
                Invasion.ENEMY_IN_ROW_COUNT = 40;
                Invasion.ENEMY_ROWS_COUNT = 4;
                Invasion.ENEMY_HEIGHT =10;
                Invasion.ENEMY_WIDTH =10;
                dispose();
            }
        });
