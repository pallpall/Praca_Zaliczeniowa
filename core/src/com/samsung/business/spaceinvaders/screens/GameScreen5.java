...
//screengry//
public class GameScreen5 extends AbstractScreen {
    ...
    public GameScreen5(SpaceInvaders spaceInvaders) {
    ...
    public void create() {
        ...
        invasion.listenOnDestroyed(new Invasion.OnEnemyDestroyed() {
            ...
            public void onEnemyDestroyed(EnemySpaceship enemy) {
                spaceInvaders.getScore().addScore(140);
            }
        });
        ...
        invasion.listenOnInvasionDestroyed(new Invasion.OnInvasionDestroyed() {
            ...
            public void onInvasionDestroyed() {
                spaceInvaders.win5();
                Invasion.ENEMY_IN_ROW_COUNT = 44;
                Invasion.ENEMY_ROWS_COUNT = 5;
